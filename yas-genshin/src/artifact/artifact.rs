...
impl ArtifactSetName {
    ...
    pub fn from_zh_cn(s: &str) -> Option<ArtifactSetName> {
        match s {
            "磐陀裂生之花" | "嵯峨群峰之翼" | "星罗圭壁之晷" | "星罗圭璧之晷" | "巉岩琢塑之樽" | "不动玄石之相" => Some(ArtifactSetName::ArchaicPetra),
            "历经风雪的思念" | "摧冰而行的执望" | "冰雪故园的终期" | "遍结寒霜的傲骨" | "破冰踏雪的回音" => Some(ArtifactSetName::BlizzardStrayer),
            "染血的铁之心" | "染血的黑之羽" | "骑士染血之时" | "染血骑士之杯" | "染血的铁假面" => Some(ArtifactSetName::BloodstainedChivalry),
            "魔女的炎之花" | "魔女常燃之羽" | "魔女破灭之时" | "魔女的心之火" | "焦灼的魔女帽" => Some(ArtifactSetName::CrimsonWitch),
            "角斗士的留恋" | "角斗士的归宿" | "角斗士的希冀" | "角斗士的酣醉" | "角斗士的凯旋" => Some(ArtifactSetName::GladiatorFinale),
            "饰金胸花" | "追忆之风" | "坚铜罗盘" | "沉波之盏" | "酒渍船帽" => Some(ArtifactSetName::HeartOfDepth),
            "渡火者的决绝" | "渡火者的解脱" | "渡火者的煎熬" | "渡火者的醒悟" | "渡火者的智慧" => Some(ArtifactSetName::LavaWalker),
            "远方的少女之心" | "少女飘摇的思念" | "少女苦短的良辰" | "少女片刻的闲暇" | "少女易逝的芳颜" => Some(ArtifactSetName::MaidenBeloved),
            "宗室之花" | "宗室之翎" | "宗室时计" | "宗室银瓮" | "宗室面具" => Some(ArtifactSetName::NoblesseOblige),
            "夏祭之花" | "夏祭终末" | "夏祭之刻" | "夏祭水玉" | "夏祭之面" => Some(ArtifactSetName::RetracingBolide),
            "平雷之心" | "平雷之羽" | "平雷之刻" | "平雷之器" | "平雷之冠" => Some(ArtifactSetName::ThunderSmoother),
            "雷鸟的怜悯" | "雷灾的孑遗" | "雷霆的时计" | "降雷的凶兆" | "唤雷的头冠" => Some(ArtifactSetName::ThunderingFury),
            "野花记忆的绿野" | "猎人青翠的箭羽" | "翠绿猎人的笃定" | "翠绿猎人的容器" | "翠绿的猎人之冠" => Some(ArtifactSetName::ViridescentVenerer),
            "乐团的晨光" | "琴师的箭羽" | "终幕的时计" | "终末的时计" | "吟游者之壶" | "指挥的礼帽" => Some(ArtifactSetName::WandererTroupe),
            "战狂的蔷薇" | "战狂的翎羽" | "战狂的时计" | "战狂的骨杯" | "战狂的鬼面" => Some(ArtifactSetName::Berserker),
            "勇士的勋章" | "勇士的期许" | "勇士的坚毅" | "勇士的壮行" | "勇士的冠冕" => Some(ArtifactSetName::BraveHeart),
            "守护之花" | "守护徽印" | "守护座钟" | "守护之皿" | "守护束带" => Some(ArtifactSetName::DefenderWill),
            "流放者之花" | "流放者之羽" | "流放者怀表" | "流放者之杯" | "流放者头冠" => Some(ArtifactSetName::Exile),
            "赌徒的胸花" | "赌徒的羽饰" | "赌徒的怀表" | "赌徒的骰盅" | "赌徒的耳环" => Some(ArtifactSetName::Gambler),
            "教官的胸花" | "教官的羽饰" | "教官的怀表" | "教官的茶杯" | "教官的帽子" => Some(ArtifactSetName::Instructor),
            "武人的红花" | "武人的羽饰" | "武人的水漏" | "武人的酒杯" | "武人的头巾" => Some(ArtifactSetName::MartialArtist),
            ...
            "故人之心" | "归乡之羽" | "逐光之石" | "异国之盏" | "感别之冠" => Some(ArtifactSetName::ResolutionOfSojourner),
            "学士的书签" | "学士的羽笔" | "学士的时钟" | "学士的墨杯" | "学士的镜片" => Some(ArtifactSetName::Scholar),
            "奇迹之花" | "奇迹之羽" | "奇迹之沙" | "奇迹之杯" | "奇迹耳坠" => Some(ArtifactSetName::TinyMiracle),
            "冒险家之花" | "冒险家尾羽" | "冒险家怀表" | "冒险家金杯" | "冒险家头带" => Some(ArtifactSetName::Adventurer),
            "幸运儿绿花" | "幸运儿鹰羽" | "幸运儿沙漏" | "幸运儿之杯" | "幸运儿银冠" => Some(ArtifactSetName::LuckyDog),
            "游医的银莲" | "游医的枭羽" | "游医的怀钟" | "游医的药壶" | "游医的方巾" => Some(ArtifactSetName::TravelingDoctor),
            "勋绩之花" | "昭武翎羽" | "金铜时晷" | "盟誓金爵" | "将帅兜鍪" => Some(ArtifactSetName::TenacityOfTheMillelith),
            "无垢之花" | "贤医之羽" | "停摆之刻" | "超越之盏" | "嗤笑之面" => Some(ArtifactSetName::PaleFlame),
            "明威之镡" | "切落之羽" | "雷云之笼" | "绯花之壶" | "华饰之兜" => Some(ArtifactSetName::EmblemOfSeveredFate),
            "羁缠之花" | "思忆之矢" | "朝露之时" | "祈望之心" | "无常之面" => Some(ArtifactSetName::ShimenawaReminiscence),
            "荣花之期" | "华馆之羽" | "众生之谣" | "梦醒之瓢" | "形骸之笠" => Some(ArtifactSetName::HuskOfOpulentDreams),
            "海染之花" | "渊宫之羽" | "离别之贝" | "真珠之笼" | "海祇之冠" => Some(ArtifactSetName::OceanHuedClam),
            ...
            _ => {
                ...
                let all_names = vec![
                    ...
                    "黄金乐曲的变奏", "黄金飞鸟的落羽", "黄金时代的先声", "黄金之夜的喧嚣", "黄金剧团的奖赏",
                    ...
                    "诸圣的礼冠", "灵髓的根脉", "异种的期许", "夜鸣莺的尾羽", "纷争的前宴",
                    "被浸染的缨盔", "执灯人的誓词", "不死者的哀铃", "未吹响的号角",
                    "深廊的遂失之冕", "深廊的漫远之约", "深廊的回奏之歌", "深廊的湮落之刻", "深廊的饫赐之宴",
                    "永劫之冕", "深罪之羽", "渴真之花", "谕告之钟", "满溢之壶",
                    "司信者的圣冕", "受福者的白羽", "流离者的晶泪", "祭霜者的迷狂", "至纯者的欢荣",
                    "哀慕的恋歌", "晨光的明誓", "风花的箴铭", "春律的片刻", "未言的宴话",
                    "献与月的银冕", "献与月的离光", "献与月的华梦", "献与月的终时", "献与月的酹祭",
                ];

                for name in all_names {
                    let dist = edit_distance::edit_distance(s, name);
                    if dist < min_dist {
                        min_dist = dist;
                ...
                if let Some(best) = best_match {
                    let limit = if s.len() < 4 { 1 } else { 2 };
                    if min_dist <= limit {
                        return Self::from_zh_cn(best);
                    }
                }
        ...
        match s {
            ...
            _ => {
                ...
                for slot in all_slots {
                    let dist = edit_distance::edit_distance(s, slot);
                    if dist < min_dist {
                        min_dist = dist;
                        best_match = Some(slot);
                    }
                }
...
mod tests {
    ...
    fn test_fuzzy_match_name() {
        // "明威之" -> "明威之镡"
        let s1 = "明威之";
        let name1 = ArtifactSetName::from_zh_cn(s1);
        assert_eq!(name1, Some(ArtifactSetName::EmblemOfSeveredFate));

        // "金铜时唇" -> "金铜时晷"
        let s2 = "金铜时唇";
        let name2 = ArtifactSetName::from_zh_cn(s2);
        assert_eq!(name2, Some(ArtifactSetName::TenacityOfTheMillelith));
    }

    #[test]
    fn test_fuzzy_match_slot_debug() {
        // "明威之" -> "明威之镡" (Flower? No, 明威之镡 is Emblem Flower)
        // Emblem Flower is 明威之镡
        let s1 = "明威之";
        let slot1 = ArtifactSlot::from_zh_cn(s1);
        assert_eq!(slot1, Some(ArtifactSlot::Flower));
    }
}
